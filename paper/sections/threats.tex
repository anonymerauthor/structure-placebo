...
The two targets differ in what their scores are computed from, deliberately:
centrality is a property of the graph alone, quality a property of the run's
own history. That they yield different outcomes under the same control is part
of the calibration, but it also means neither should be read as representative
of score weighting in general.
